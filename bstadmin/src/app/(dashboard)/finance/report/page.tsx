                  ...
                  <Table className="text-sm">
                    ...
                    <TableBody className="divide-y divide-slate-200">
                      {selectedLines.map((line) => (
                        <TableRow key={`${line.bookingId}-${line.tourDate}`}>
                          <TableCell className="whitespace-nowrap px-3 py-2">{formatDate(line.tourDate)}</TableCell>
                          ...
                          <TableCell className="whitespace-nowrap px-3 py-2 text-right font-semibold text-slate-900">
                      ...
                      {selectedLines.length === 0 ? (
                        <TableRow>
                          <TableCell colSpan={3} className="px-3 py-10 text-center text-sm text-slate-500">
